...
class Net(nn.Module):
    def __init__(self, device, num_embeddings=21, embedding_dim=32,
                 ...
                 linear_out=20, linear_dropout=0.5, extra_dense_layer=False):
        super(Net, self).__init__()
        
        self.device = device
        self.extra_dense_layer = extra_dense_layer
    ...
    def forward(self, batch, seq_lengths):
        ...
        if self.extra_dense_layer:
            embedded_batch = nn.functional.relu(self.fc1(embedded_batch))
